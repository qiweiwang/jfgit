/** 
 * Angular2ModalVex Copyright 2017
 * Licensed under MIT
 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["angular2Modal.vex"] = factory(require("angular2-modal"), require("@angular/core"), require("@angular/common"));
	else
		root["angular2Modal.vex"] = factory(root["angular2-modal"], root["@angular/core"], root["@angular/common"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_36__) {
...
var VEXModalContextBuilder = (function (_super) {
    ...
    function VEXModalContextBuilder(defaultValues, initialSetters, baseType) {
        ...
        return _super.call(this, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["extend"])(DEFAULT_VALUES, defaultValues || {}), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["arrayUnion"])(DEFAULT_SETTERS, initialSetters || []), baseType || VEXModalContext // https://github.com/Microsoft/TypeScript/issues/7234
        ) || this;
    }
    /**
     *
    ...
    VEXModalContextBuilder.prototype.overlayClosesOnClick = function (value) {
        this[__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["privateKey"])('isBlocking')] = !value;
        return this;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_operator_combineLatest__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__presets_dropin_preset__ = __webpack_require__(9);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Modal = (function (_super) {
    ...
    Modal.prototype.alert = function () {
        return new __WEBPACK_IMPORTED_MODULE_3__presets_dropin_preset__["b" /* DropInPresetBuilder */](this, __WEBPACK_IMPORTED_MODULE_2_angular2_modal__["DROP_IN_TYPE"].alert, /** @type {?} */ ({ isBlocking: false }));
    };
    /**
     * @return {?}
     */
    Modal.prototype.prompt = function () {
        return new __WEBPACK_IMPORTED_MODULE_3__presets_dropin_preset__["b" /* DropInPresetBuilder */](this, __WEBPACK_IMPORTED_MODULE_2_angular2_modal__["DROP_IN_TYPE"].prompt, /** @type {?} */ ({
            isBlocking: true,
            keyboard: null
        }));
    };
    ...
    Modal.prototype.confirm = function () {
        return new __WEBPACK_IMPORTED_MODULE_3__presets_dropin_preset__["b" /* DropInPresetBuilder */](this, __WEBPACK_IMPORTED_MODULE_2_angular2_modal__["DROP_IN_TYPE"].confirm, /** @type {?} */ ({
            isBlocking: true,
            keyboard: null
        }));
    };
    ...
    Modal.prototype.create = function (dialogRef, content, bindings) {
        ...
        var /** @type {?} */ containerRef = this.createContainer(dialogRef, __WEBPACK_IMPORTED_MODULE_2_angular2_modal__["CSSDialogContainer"], content, bindings);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_modal__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_modal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modal_context__ = __webpack_require__(6);
...
var DialogPresetBuilder = (function (_super) {
    ...
    function DialogPresetBuilder(modal, defaultValues, initialSetters, baseType) {
        ...
        if (initialSetters === void 0) { initialSetters = undefined; }
        if (baseType === void 0) { baseType = undefined; }
        return _super.call(this, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["extend"])({ modal: modal, component: __WEBPACK_IMPORTED_MODULE_2__dialog_form_modal__["a" /* DialogFormModal */], buttons: [], defaultResult: true }, defaultValues || {}), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["arrayUnion"])(DEFAULT_SETTERS, initialSetters || []), baseType || DialogPreset // https://github.com/Microsoft/TypeScript/issues/7234
        ) || this;
    }
    /**
     * @param {?} css
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dialog_preset__ = __webpack_require__(8);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var DropInPreset = (function (_super) {
    ...
    Object.defineProperty(DropInPreset.prototype, "showInput", {
         ...
         */
        get: function () {
            return this.dropInType === __WEBPACK_IMPORTED_MODULE_0_angular2_modal__["DROP_IN_TYPE"].prompt;
        },
        enumerable: true,
        configurable: true
    });
...
var DropInPresetBuilder = (function (_super) {
    ...
    function DropInPresetBuilder(modal, dropInType, defaultValues) {
        if (defaultValues === void 0) { defaultValues = undefined; }
        return _super.call(this, modal, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["extend"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_angular2_modal__["extend"])({ modal: modal, dropInType: dropInType }, DEFAULT_VALUES), defaultValues || {}), DEFAULT_SETTERS, DropInPreset) || this;
    }
    /**
     * @param {?} config
     * @return {?}
    ...
    DropInPresetBuilder.prototype.$$beforeOpen = function (config) {
        ...
        switch (config.dropInType) {
            case __WEBPACK_IMPORTED_MODULE_0_angular2_modal__["DROP_IN_TYPE"].prompt:
                config.defaultResult = undefined;
            case __WEBPACK_IMPORTED_MODULE_0_angular2_modal__["DROP_IN_TYPE"].confirm:
                if (config.cancelBtn) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modal__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__presets_dropin_preset__ = __webpack_require__(9);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_2__presets_dropin_preset__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_2__presets_dropin_preset__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dialog_form_modal__ = __webpack_require__(2);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_3__dialog_form_modal__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_3__dialog_form_modal__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_3__dialog_form_modal__["c"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__presets_dialog_preset__ = __webpack_require__(8);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_4__presets_dialog_preset__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_4__presets_dialog_preset__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__vex_module__ = __webpack_require__(19);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return __WEBPACK_IMPORTED_MODULE_5__vex_module__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return __WEBPACK_IMPORTED_MODULE_5__vex_module__["b"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vex__ = __webpack_require__(17);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "VEXModalContext", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "VEXModalContextBuilder", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DropInPreset", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DropInPresetBuilder", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DialogFormModal", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["f"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "FormDropIn", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["g"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "VEXDialogButtons", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["h"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DialogPreset", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["i"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DialogPresetBuilder", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["j"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "VexModalModule", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["k"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "providers", function() { return __WEBPACK_IMPORTED_MODULE_0__vex__["l"]; });
/**
 * Generated bundle index. Do not edit.
 */

//# sourceMappingURL=angular2-modal-vex.ng-flat.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_modal__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_modal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_angular2_modal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modal__ = __webpack_require__(7);
...
var root_1 = __webpack_require__(1);
var isArrayLike_1 = __webpack_require__(29);
var isPromise_1 = __webpack_require__(30);
var isObject_1 = __webpack_require__(16);
var Observable_1 = __webpack_require__(3);
...
//# sourceMappingURL=angular2-modal-vex.webpack.umd.js.map